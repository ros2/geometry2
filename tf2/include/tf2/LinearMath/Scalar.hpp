...
#ifndef TF2_SCALAR_HPP
#define TF2_SCALAR_HPP
...
#define TF2_DEBUG
		...
		#else
			//#define TF2_HPPAS_ALIGNED_ALLOCATOR
...
#define TF2SIMD_HPPALF_PI      (TF2SIMD_2_PI * tf2Scalar(0.25))
...
#define TF2_DECLARE_HPPANDLE(name) typedef struct name##__ { int unused; } *name
